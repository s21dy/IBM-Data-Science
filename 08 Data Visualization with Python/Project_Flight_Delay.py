...
app.layout = html.Div(children=[ html.H1('Flight Details Statistics Dashboard', 
                                ...
                                html.Div([
                                        html.Div(dcc.Graph("nas-plot")),
                                        html.Div(dcc.Graph("security-plot"))
                                ], style={'display': 'flex'}),
...
Returns:
    Computed average dataframes for carrier delay, weather delay, NAS delay, s
    ecurity delay, and late aircraft delay.
"""
